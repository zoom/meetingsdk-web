...
// Exit with error unless this package points to gov CDN and not commercial CDN.
if (!sourceUrlResult || sourceUrlResult.hasZoomUs || (!sourceUrlResult.hasZoomGov && !sourceUrlResult.hasZoomMil)) {
